...
class SynPASS_11_weather(CustomDataset):
    ...
    def __init__(self,
        ...
        super(SynPASS_11_weather, self).__init__(
    ...
    def pre_pipeline(self, results):
        super(SynPASS_11_weather, self).pre_pipeline(results)
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
        ...
        #     print("img path:", img)
        #     print("parsed scene:", scene)
        #     print("list file sample:", list(all_map_dn_val)[:5])

        # print(f"After weather filter ({weather}): &&&&&&&&&&&&&&&&&&&&&&&& \n")
        # print(len(img_paths))
        # print(len(mask_paths))
        # 

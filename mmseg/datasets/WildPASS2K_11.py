...
class WildPASS2K_11(CustomDataset):
    """Cityscapes dataset.
    ...
    # CLASSES = ('Building','Fence','Other','Pedestrian','Pole','RoadLine',
    ...
    # shared_class = ('road', 'sidewalk', 'building', 'wall', 'fence', 'pole',
    ...
    def __init__(self,
        ...
        super(WildPASS2K_11, self).__init__(
            img_suffix=img_suffix, seg_map_suffix=seg_map_suffix, **kwargs)

        self.pseudo_margins = crop_pseudo_margins
        self.valid_mask_size = [400, 2048] #[1024, 2048]

    def pre_pipeline(self, results):
        super(WildPASS2K_11, self).pre_pipeline(results)

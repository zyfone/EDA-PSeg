...
class DensePASSDataset_11(CustomDataset):
    ...
    # PALETTE = CityscapesDataset_11.PALETTE

    def __init__(self, **kwargs):
        # assert kwargs.get('split') in [None, 'train']
        # if 'split' in kwargs:
        #     kwargs.pop('split')
        super(DensePASSDataset_11, self).__init__(
            img_suffix='.png',
            # seg_map_suffix='labelTrainIds.png',
            seg_map_suffix='labelTrainIds_syn_13.png',
            split=None,
            **kwargs)

...
class CityscapesDataset_13(CustomDataset):
    """Cityscapes dataset.
    ...
    def pre_pipeline(self, results):
        super(CityscapesDataset_13, self).pre_pipeline(results)
